        ...
        viewport={{ once: true }}
         className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' &&<div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                <input  onChange={e=> setName(e.target.value)} value ={name} type='text' className='outline-none text-sm' placeholder='Email id' required/>


            </div>}
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.email_icon} alt=""/>
                <input onChange={e=> setEmail(e.target.value)} value ={email} type='text' className='outline-none text-sm' placeholder='Full Name' required/>
