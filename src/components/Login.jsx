    ...
    <div className='absolute top-0 left-0 right-0 bottom-0 z-0 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        <form className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' &&<div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                ...
                <input type='text' className='outline-none text-sm' placeholder='Email id' required/>


            </div>}
            <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
                <img src={assets.email_icon} alt=""/>
                <input type='email' className='outline-none text-sm' placeholder='Full Name' required/>
