...
const Result = () => {
  ...
  return (
    < motion.form
      ...
      {!isImageLoaded && (
        <div className="flex w-full max-w-al bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full">
          <input
      ...
      {isImageLoaded && (
        <div className="flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10">
          <p onClick={() => setIsImageLoaded(false)} className="bg-transparet border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer">
            Generate Another
          </p>
          <a
            href={image}
